...
class ServidorFormacaoRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'anexo_frente' => 'required|file|mimes:pdf|max:5120', // 5MB
            // 'anexo_verso' => 'required|file|mimes:pdf|max:5120', // 5MB
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'anexo_frente.required' => 'O anexo frente é obrigatória.',
