...
<table
    ...
    <tr>
        <td style="border: 1px solid black;" colspan="4"><strong>UNIDADE\ÓRGÃO\ENTIDADE:</strong> {{ $avaliacao->servidor_avaliacao_desempenho_servidor->unidadeServidor->nome ?? '-' }}</td>
    </tr>
    <tr>
