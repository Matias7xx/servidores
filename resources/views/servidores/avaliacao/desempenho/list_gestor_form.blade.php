<div class="grid gap-6 md:grid-cols-2">
    <div class="col-span-1 flex items-center">
        <h2 class="text-2xl font-semibold text-gray-700">
            Avaliação de Desempenho do(a) Gestor(a)
        </h2>
    </div>
            ...
            @foreach ($avaliacao as $item)
                <tr class="text-black">
                    ...
                    <td>
                        ...
                        <a href="javascript:abrirPagina('{{ route('servidores.ficha_avaliacao_gestor', ['id' => $item->id_servidor, 'mes' => $item->mes, 'ano' => $item->ano]) }}', 600, 600)"
...
@else
<div class="p-4">
    <p class="text-gray-500 text-center">Nenhuma avaliação encontrada.</p>
</div>
@endif